...
<div class="acc-name acc-name<?php echo $nameNumber++; ?> seating-tile">
  <div class="product-btn seating-tile-btn">
	  <a href = "<?php the_sub_field('product_link'); ?>" style="color:white;">
		<?php the_sub_field('product_name'); ?>  
	  </a>
	</div>
<!--   <div class="product-btn product-btn<?php echo $contentNumber++; ?>">More Info</div> -->
<!--  	<a class="product-btn" href=" <?php the_sub_field('product_info'); ?>" style="color:#ffffff;">More Info</a> -->
  </div><!--acc-name-->
