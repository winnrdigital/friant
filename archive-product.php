...
<!------- hero section --------->
			...
			<div class="hero-wrap" style="background-image: url(<?php the_field('hero_image', 'option'); ?>);">
            <div class="hero-inner">
            <div class="hero-content">
            <h1><?php the_field('hero_title', 'option'); ?></h1>
            <h2><?php the_field('hero_subtext', 'option'); ?></h2>
            </div><!--hero-content-->
            </div><!--hero-inner-->
            </div><!--hero-wrap-->
...
<h2><?php the_field('about_text', 'option'); ?></h2>
