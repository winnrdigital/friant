...
<!------- hero section --------->
			...
			<div class="hero-wrap" style="background-image: url(<?php the_field('accessories_hero_image', 'option'); ?>);">
            <div class="hero-inner">
            <div class="hero-content">
            <h1><?php the_field('accessories_hero_title', 'option'); ?></h1>
            <h2><?php the_field('accessories_hero_subtext', 'option'); ?></h2>
            </div><!--hero-content-->
            </div><!--hero-inner-->
            </div><!--hero-wrap-->
...
<h2><?php the_field('accessories_about_text', 'option'); ?></h2>
...
<?php 
// the query
$wpb_all_query = new WP_Query(array('post_type'=>'product', 'post_status'=>'publish', 'category_name'=>'Accessories', 'posts_per_page'=>-1)); ?>
 
