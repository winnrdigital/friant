...
})(window,document,'script','dataLayer','GTM-WKXSB5GD');</script>
...
<div class="top-header-wrap">
  <div class="top-header">
	...
	<div class="top-header-lt">
    	<!-- Due to COVID-19 there are potentials for shipping delays. -->
		<?php //the_field('top_bar_text', 'options'); ?>
		<ul class="top-header-menu">
			<li><a href="<?php echo 'https://www.shopfriant.com/'; ?>">Shop</a></li>
			<li><a href="<?php echo site_url(); ?>">Learn</a></li>
		</ul>
    </div>
<div><strong>Current template:</strong> <?php get_page_template( true ); ?></div>
  
    <div class="top-header-rt">
    	<a href="http://dealers.friant.com/" target="_blank" >Dealer Resource Center</a>
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>/blog">Latest News</a>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WKXSB5GD"
