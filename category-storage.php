...
<div id="main-content">
  ...
  <div class="hero-wrap" style="background-image: url(<?php the_field('storage_hero_image', 'option'); ?>);">
    <div class="hero-inner">
      <div class="hero-content">
        <h1><?php the_field('storage_hero_title', 'option'); ?></h1>
        <h2><?php the_field('storage_hero_subtext', 'option'); ?></h2>
      </div><!--hero-content-->
    </div><!--hero-inner-->
  </div><!--hero-wrap-->
  ...
  <div class="main-product-wrap">
    ...
    <h2><?php the_field('storage_about_text', 'option'); ?></h2>
  ...
  <div class="product-loop-wrap">
    <?php
    // the query
    $wpb_all_query = new WP_Query(array('post_type' => 'product', 'post_status' => 'publish', 'category_name' => 'Storage', 'posts_per_page' => -1)); ?>
